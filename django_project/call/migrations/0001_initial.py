    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.CharField(choices=[('NA', 'Norte América'), ('LA', 'Latinoamérica'), ('EU', 'Europa'), ('OC', 'Oceanía'), ('AS', 'Asia'), ('AN', 'Uniandes'), ('SG', 'Convenio Sigueme/Nacional')], max_length=10)),
                ('country', models.CharField(max_length=50)),
                ('city', models.CharField(max_length=50)),
                ('academic_offer', models.CharField(max_length=255)),
                ('exchange_info', models.CharField(max_length=255)),
                ('flag_image_url', models.URLField(blank=True, default='https://identidad.unal.edu.co/fileadmin/user_upload/escudo_unal_2015-01.jpg', max_length=500, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Call',
            fields=[
                ...
                ('university', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='call.university')),
            ],
        ),
    ]
