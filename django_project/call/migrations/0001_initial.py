    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.CharField(choices=[('NA', 'Norte América'), ('LA', 'Latinoamérica'), ('EU', 'Europa'), ('OC', 'Oceanía'), ('AN', 'Uniandes'), ('SG', 'Convenio Sigueme/Nacional')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(choices=[('en', 'Inglés'), ('es', 'Español'), ('fr', 'Francés'), ('pt', 'Portugués'), ('de', 'Alemán'), ('it', 'Italiano'), ('ko', 'Coreano'), ('ru', 'Ruso'), ('zh', 'Chino'), ('xx', 'Otro')], max_length=10)),
