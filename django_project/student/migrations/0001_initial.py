...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_user', models.CharField(choices=[('E', 'Estudiante'), ('T', 'Trabajador')], max_length=10)),
                ...
                ('ethnicity', models.CharField(choices=[('IN', 'Indígena'), ('AF', 'Afrocolombiana'), ('RG', 'Rom o gitana'), ('NA', 'Ninguna')], default=('NA', 'Ninguna'), max_length=3)),
                ('headquarter', models.CharField(choices=[('BO', 'Bogotá'), ('AM', 'Amazonia'), ('CA', 'Caribe'), ('MA', 'Manizales'), ('ME', 'Medellín'), ('OR', 'Orinoquia'), ('PA', 'Palmira'), ('TU', 'Tumaco'), ('LP', 'La Paz')], default=('BO', 'Bogotá'), max_length=3)),
                ...
                ('admission', models.CharField(choices=[('REGUL', 'Regular'), ('PAES', 'PAES'), ('PEAMA', 'PEAMA')], default=('REGUL', 'Regular'), max_length=10)),
